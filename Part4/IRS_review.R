...
# Scatter Plot
# - It is important to use the same scale for the same groups!!!
# - ex. for Sepal Length vs. W, use the same scale for all three species, as well as for Petal length vs. W

# Avgs into Bar Plot
# - summarise_each()

# Box Plot
# - 1Q, 2Q, 3Q -> IRQ in the box, tail is 1Q-1.5 IRQ & 3Q + 1.5IRQ, Outliers are over the tails
